        ...
        <div id="wrap">
            <div id="wrap_left">
                ...
                <div id="profile_right" style="width:650px;">
                    <div class="set_header">常见问题帮助</div>
                            ...
                            <DIV class="mod-page-main wordwrap clearfix">
                                <DIV class=x-page-container>
                                    <DIV class="mod-notfound grid-98">
                                        <br />
                                        在实际操作中遇到任何问题，请联系作者邮箱<a href="mailto:bcsflilong@gmail.com?subject=来自牢骚网的邮件${session.LOGIN_USER.user_name}">bcsflilong@gmail.com </a>
                                        <br />
                                        由于本网站的开发测试都是作者Tone一个人在做，所以直到目前为止本站中还是存在一些Bug，
                                        <br />
                                        由此给大家带来的不便，还请大家谅解。使用中出现bug，请抽出您的宝贵时间提交给<a href="mailto:bcsflilong@gmail.com?subject=来自牢骚网的邮件,报BUG${session.LOGIN_USER.user_name}">bcsflilong@gmail.com </a>
                                        <br />
                                        
                                        
                                            <s:if test="#session.LOGIN_USER.user_id!=null">
                                                或者你可以点击下面的链接 去
                                                <a href="<%=basePath%>NavigateAction?navFlag=bug">提交bug</a>
                                            </s:if>
