        ...
        <div id="wrap">
            <div id="wrap_left">
                ...
                <div id="profile_right" style="width:650px;">
                    <div class="set_header">关于牢骚网</div>
                            ...
                            <DIV class="mod-page-main wordwrap clearfix">
                                <DIV class=x-page-container>
                                    <DIV class="mod-notfound grid-98">
                                        <br />    
                                        源自玛丽莲曼森的 This is the new Shit!
                                        <br />           
                                        天没天理  人没人性！以扯淡的态度面对狗屎的人生！
                                        <br /> 
                                        这就是牢骚网的作者!<img src="<%=basePath%>Images/logo.jpg"/>
                                        <br /> 本站始创与2013年4月，于2014年5月19日基本完成。
