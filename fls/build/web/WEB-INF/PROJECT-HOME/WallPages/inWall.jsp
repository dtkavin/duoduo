<%-- 
    Document   : inWall
    Created on : 2014-7-18, 11:09:27
    Author     : Tone
--%>

<%@page import="org.fls.common.utils.VideoUtils"%>
        ...
        <div id="wrap">
            <div id="wrap_left">
                ...
                <div id="profile_right" style="width:650px;">
                    ...
                    <div class="set_header">音乐列表</div>
                    <br>
                    <div class="boundary"></div>
                    <%
                        String videoPath = "Video";
                        for (String name : VideoUtils.getVideoNameList(videoPath)) {
                    %>

                    <audio src="<%=basePath%><%=videoPath%>/<%=name%>" controls="controls" >
