        ...
        <div id="wrap">
            ...
            <div id="wrap_left">
                ...
                <script type="text/javascript">
                    delayURL('www.baid.com')
                </script>
                <s:if test="#session.LOGIN_USER.user_id!=null">
                    <div id="post_comment">
                        <H3>提交Bug!</H3>
                        <div id="post_comment_box">
                            <s:form  theme="xhtml"action="BugAction!submitBug" namespace="/bug" method="post" name="bugform" onSubmit="return check_bug_Submit();"> 
                                ...
                                <input id="post_comment_btn" accesskey="s" type="submit" value="提交(Alt+S)">
                            </s:form>
                        </div>
                    </div>
                </s:if>
