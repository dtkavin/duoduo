            ...
            <div id="wrap_left">
                <div id="profile_left">
                    <div id="preview_avatar">
                        <iframe  border:none scrolling="no" frameborder="0" name="face_frame" id="face_frame" src="<%=basePath%>NavigateAction?navFlag=face&imageurl=<s:if test="#request.viewuser.user_imageurl!=null">${request.viewuser.user_imageurl}&viewuser_imageuserid=${request.viewuser.user_id}</s:if><s:else>mynopic</s:else>">
                            </iframe>
                        </div>
                        <ul>
                ...
                <div id="profile_right">
                    ...
                    <s:if test="#request.viewflag=='index'">
                        ...
                        <div id="profile_right_nav">&nbsp;${request.viewuser.user_name}发的牢骚:</div>

                        <s:if test="%{pageEntity.allRow >= 1}">
                            <s:iterator value="pageEntity.list" var="theme">
                                <div class="infobox"> 
                                    <div class="c">
                                        <a href="<%=basePath%>theme/ReplyAction!queryReply?theme_id=${theme.theme_id} ">
                                            <span><s:property escape="false" value="#theme.theme_content" /></span>
                                        </a>
                                    </div> 
                                    <div class="date"> 
                                        <div id="dateleft">
                                            <a href="<%=basePath%>theme/ReplyAction!queryReply?theme_id=${theme.theme_id}">查看</a> 
                                            评论(<font color="red"><s:property value="#theme.theme_replys.size"/></font>)
                                        </div> 
                                        <div id="dateright" style="width:452px;">
                                            ...
                                            <br><font color="red"><s:date name="#theme.theme_updatetime" format="yyyy-MM-dd"/> </font> 
                                            <a href="<%=basePath%>theme/ThemeAction!queryThemeByKey?searchKey=<s:property value="#theme.theme_category"/>&currentPage=1&chgEncoding=YES"><s:property value="#theme.theme_category"/> </a>            &nbsp;&nbsp;&nbsp;
                            ...
                            <div id="paging">
                                ...
                                <span>
                                    ...
                                    <s:else>
                                        <a href="<%=basePath%>user/UserInfoAction!viewUserInfo?currentPage=1">第一页</a>
                                        <a href="<%=basePath%>user/UserInfoAction!viewUserInfo?currentPage=<s:property value="%{pageEntity.currentPage-1}"/>">上一页</a> 
                                    </s:else>
                                    <s:if test="%{pageEntity.currentPage != pageEntity.totalPage}">
                                        <a href="<%=basePath%>user/UserInfoAction!viewUserInfo?currentPage=<s:property value="%{pageEntity.currentPage+1}"/>">下一页</a>
                                        <a href="<%=basePath%>user/UserInfoAction!viewUserInfo?currentPage=<s:property value="pageEntity.totalPage"/>">最后一页</a>
                                    </s:if>
                                    <s:else>
                                        <a>下一页</a>  
                                        <a>最后一页</a>
                        ...
                        <s:else>
                            <div id="nothing_found">目前还没发过牢骚<br>
                                <span>牢骚网</span>
                            </div>   
