        ...
        <div id="wrap">
            <div id="wrap_left">
                ...
                <div id="profile_right">
                    ...
                    <s:if test="#request.viewflag=='fave'">
                        ...
                        <div class="profile_title">
                            ...
                            <s:if test="#request.viewuser.user_id!=#session.LOGIN_USER.user_id">
                                ...
                                <s:if test="#request.viewuser.follow_flag=='YES'" >
                                    <span class="addfollow" id="f_${request.viewuser.user_id}" onclick="actfollowing('${request.viewuser.user_id}');">已关注</span>
                                </s:if>  
                                <s:else>
                        ...
                        <div id="profile_right_nav">&nbsp;${request.viewuser.user_name}收藏的牢骚</div>
                        ...
                        <s:if test="%{pageEntity.allRow >= 1}">
                                ...
                                <div class="infobox"> 
                                    ...
                                    <div class="date"> 
                                        ...
                                        <div id="dateright" style="width:452px;">
                                            ...
                                            <s:if test="#request.viewuser.user_id==#session.LOGIN_USER.user_id">
                                                <span id="info_${theme.theme_id}">
                                                    <a onclick="delFromFav('${theme.theme_id}')" style="cursor: pointer">-取从收藏中删除</a>
                                                </span>
                                            </s:if>
                                            <s:else>
                            ...
                            <div id="paging">
                                ...
                                <span>
                                    ...
                                    <s:else>
                                        <a href="<%=basePath%>user/UserInfoAction!viewFave?currentPage=1">第一页</a>
                                        <a href="<%=basePath%>user/UserInfoAction!viewFave?currentPage=<s:property value="%{pageEntity.currentPage-1}"/>">上一页</a> 
                                    </s:else>
                                    <s:if test="%{pageEntity.currentPage != pageEntity.totalPage}">
                                        <a href="<%=basePath%>user/UserInfoAction!viewFave?currentPage=<s:property value="%{pageEntity.currentPage+1}"/>">下一页</a>
                                        <a href="<%=basePath%>user/UserInfoAction!viewFave?currentPage=<s:property value="pageEntity.totalPage"/>">最后一页</a>
                                    </s:if>
                                    <s:else>
                                        <a>下一页</a>  
                                        <a>最后一页</a>
                        ...
                        <s:else>
                            <div id="nothing_found">目前还没收藏过牢骚<br>
                                <span>牢骚网</span>
                            </div>   
