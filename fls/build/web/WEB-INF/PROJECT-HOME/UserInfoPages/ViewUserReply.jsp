<%-- 
    Document   : ViewUserReply
    Created on : 2014-7-10, 16:39:21
    Author     : Tone
--%>
    ...
    <div id="wrap">
        <div id="wrap_left">
            ...
            <div id="profile_right">
                ...
                <s:if test="#request.viewflag=='reply'">
                    ...
                    <div id="profile_right_nav">${request.viewuser.user_name} 的 发出的评论 </div>
                    <div class="profile_title">
                    ...
                    <s:if test="%{pageEntity.allRow >= 1}">
                        <s:iterator value="pageEntity.list" var="reply">
                            <div class="infobox3">
                                <font color="red" > ${reply.reply_index}</font># &nbsp;<br>
                                <a href="<%=basePath%>theme/ReplyAction!queryReply?currentPage=${reply.currentPage_indexI}&theme_id=${reply.reply_theme.theme_id}">${reply.reply_content}</a>
                                <br>
                                <span style="color:#B1B5B5; font-weight:normal; font-size:13px;">${reply.reply_theme.theme_content}</span>
                            </div>
                        </s:iterator>
                        ...
                        <div id="paging">
                            ...
                            <span>
                                ...
                                <s:else>
                                    <a href="<%=basePath%>user/UserInfoAction!viewReply?currentPage=1">第一页</a>
                                    <a href="<%=basePath%>user/UserInfoAction!viewReply?currentPage=<s:property value="%{pageEntity.currentPage-1}"/>">上一页</a> 
                                </s:else>
                                <s:if test="%{pageEntity.currentPage != pageEntity.totalPage}">
                                    <a href="<%=basePath%>user/UserInfoAction!viewReply?currentPage=<s:property value="%{pageEntity.currentPage+1}"/>">下一页</a>
                                    <a href="<%=basePath%>user/UserInfoAction!viewReply?currentPage=<s:property value="pageEntity.totalPage"/>">最后一页</a>
                                </s:if>
                                <s:else>
                                    <a>下一页</a>  
                                    <a>最后一页</a>
                    ...
                    <s:else>
                        <div id="nothing_found">目前还没评论过别人的牢骚<br>
                            <span>牢骚网</span>
                        </div>   
