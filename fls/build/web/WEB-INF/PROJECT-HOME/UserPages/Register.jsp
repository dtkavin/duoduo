                ...
                <div id="login_state">
                    <s:if test="#session.LOGIN_USER.user_id!=null">
                        <div id="people_nav">
                            ...
                            </dl><a href="<%=basePath%>userinfo/UserInfoAction!viewFuns?viewflag=funs&currentPage=1&viewuser_id=${session.LOGIN_USER.user_id}">粉 丝</a></dd>
        ...
        <div id="wrap">
            <div id="wrap_left">
                ...
                <div id="profile_right" style="width:650px;">
                    <div class="set_header">加入牢骚网</div>
                    <div class="boundary"></div>
                    <div style="line-height:24px;">         
                        <div id="regwrap">

                            <s:form action="UserAction!register" namespace="/login" method="post" name="registerform" onSubmit="return check_register_Submit();">          
                                <div id="login_error" style="visibility:visible;">&nbsp;</div>
                                <input type="hidden" name="referer" value="">
                                <div class="reg_item">邮箱 <input type="text" name="reg_email" id="reg_email" class="textfield"> <span id="email_option">用来登录 牢骚网!</span></div>
                                <div class="reg_item">昵称 <input type="text" name="reg_nickname" id="reg_nickname" class="textfield"> <span id="nickname_option">第一印象很重要，起个响亮的名号吧</span></div>
                                <div class="reg_item">密码 <input type="password" name="reg_password" id="reg_password" class="textfield"> <span id="password_option">字母、数字或符号，最短四个字符，区分大小写</span></div>
                                <div class="reg_item">重复 <input type="password" name="reg_password2" id="reg_password2" class="textfield"> <span id="password_option">确认密码</span></div>
                                <div class="reg_item">验证 <input type="text" name="securityCode" id="securityCode" class="textfield2"/> &nbsp;&nbsp;
                                    <img class="textfield2" src="security/SecurityCodeImageAction"  id="Verify" alt="看不清，换一张" />
                                    <span id="password_option">输入正确验证码</span></div>
                                <div id="tos">
                                    <input type="checkbox" name="alread" id="alread"/> 已阅读<span><a href="javascript:void(0);" onclick="showLciense('<%=basePath%>NavigateAction?navFlag=license');" >用户须知</a></span>
                                    已经拥有牢骚网账号？<span><a href="<%=basePath%>NavigateAction?navFlag=login">直接登录</a></span>

                                </div>
                                <div class="reg_item"><input type="submit" name="reg_btn" id="reg_btn" class="reg_btn" value="注 册">
